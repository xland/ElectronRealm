...
var require_package = __commonJS({
  "node_modules/realm/package.json"(exports, module2) {
    module2.exports = {
      name: "realm",
...
var require_utils = __commonJS({
  "node_modules/realm/lib/utils.js"(exports, module2) {
    var require_method = require;
    function node_require(module3) {
      return require_method(module3);
    }
...
// node_modules/@realm/common/dist/bundle.cjs.js
var require_bundle_cjs = __commonJS({
  "node_modules/@realm/common/dist/bundle.cjs.js"(exports) {
    "use strict";
    ...
    var PROXY_TARGET = Symbol("PROXY_TARGET");
    var IS_PROXIED_DICTIONARY = Symbol("IS_PROXIED_DICTIONARY");
    var symbols = /* @__PURE__ */ Object.freeze({
      __proto__: null,
      PROXY_TARGET,
      IS_PROXIED_DICTIONARY
    });
    ...
    var isDevelopmentModeImpl = () => {
      var _a;
      try {
        const { app: app2 } = require("electron");
        return app2 !== void 0 && !app2.isPackaged;
      } catch (_) {
      }
...
var require_set_methods = __commonJS({
  "node_modules/realm/lib/set-methods.js"(exports, module2) {
    module2.exports = function(realmConstructor) {
      function forEach(callback) {
        const elements = Array.from(this.values());
        elements.forEach((element) => callback(element));
      }
      function toJSON(_, cache = /* @__PURE__ */ new Map()) {
        const elementArray = Array.from(this.values());
        return elementArray.map(
          (item, index) => item instanceof realmConstructor.Object ? item.toJSON(index.toString(), cache) : item
        );
      }
      return {
...
var require_collection_methods = __commonJS({
  "node_modules/realm/lib/collection-methods.js"(exports, module2) {
    module2.exports = function(realmConstructor) {
      ...
      ["entries", "keys", "values"].forEach(function(methodName) {
        var method = function() {
          ...
          var self2 = this.type === "object" || isSet ? this.snapshot() : this;
          var index = 0;
          return Object.create(iteratorPrototype, {
            next: {
              value: function() {
                if (!self2 || index >= self2.length) {
                  self2 = null;
                ...
                switch (methodName) {
                  case "entries":
                    value = isSet ? [self2[index], self2[index]] : [index, self2[index]];
                    break;
                  case "keys":
                    value = isSet ? void 0 : index;
                    break;
                  default:
                    value = self2[index];
                    break;
...
// node_modules/realm/lib/dictionary.js
var require_dictionary = __commonJS({
  "node_modules/realm/lib/dictionary.js"(exports, module2) {
    var { symbols } = require_bundle_cjs();
...
var require_serializer = __commonJS({
  "node_modules/bson/lib/parser/serializer.js"(exports) {
    ...
    function serializeObject(buffer, key, value, index, checkKeys, depth, serializeFunctions, ignoreUndefined, isArray, path2) {
      if (checkKeys === void 0) {
        checkKeys = false;
      }
      if (depth === void 0) {
      ...
      index = index + numberOfWrittenBytes;
      buffer[index++] = 0;
      var endIndex = serializeInto(buffer, value, checkKeys, index, depth + 1, serializeFunctions, ignoreUndefined, path2);
      path2.pop();
      return endIndex;
    }
    ...
    function serializeInto(buffer, object, checkKeys, startingIndex, depth, serializeFunctions, ignoreUndefined, path2) {
      if (checkKeys === void 0) {
        checkKeys = false;
      }
      ...
      if (Array.isArray(object)) {
        for (var i = 0; i < object.length; i++) {
          ...
          if (typeof value === "string") {
            ...
            index = serializeObject(buffer, key, value, index, checkKeys, depth, serializeFunctions, ignoreUndefined, true, path2);
        ...
        while (!done) {
          ...
          if (type === "string") {
            ...
            index = serializeObject(buffer, key, value, index, checkKeys, depth, serializeFunctions, ignoreUndefined, false, path2);
...
var require_bson = __commonJS({
  "node_modules/bson/lib/bson.js"(exports) {
    ...
    function deserialize(buffer2, options) {
      ...
      return deserializer_1.deserialize(ensure_buffer_1.ensureBuffer(buffer2), options);
    }
    exports.deserialize = deserialize;
...
// node_modules/@realm/network-transport/node_modules/node-fetch/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/@realm/network-transport/node_modules/node-fetch/lib/index.js"(exports, module2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@realm/network-transport/dist/bundle.cjs.js
var require_bundle_cjs2 = __commonJS({
  "node_modules/@realm/network-transport/dist/bundle.cjs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_app = __commonJS({
  "node_modules/realm/lib/app.js"(exports, module2) {
    var { promisify } = require_utils();
    var instanceMethods = {
      logIn(credentials) {
...
var require_mongo_client = __commonJS({
  "node_modules/realm/lib/mongo-client.js"(exports, module2) {
    var { EJSON } = require_bson();
    var { DefaultNetworkTransport } = require_bundle_cjs2();
    var { safeGlobalThis } = require_bundle_cjs();
    var { cleanArguments, getEnvironment } = require_utils();
    ...
    var MongoDBCollection = class {
      ...
      async *watch({ ids = void 0, filter = void 0 } = {}) {
    ...
    module2.exports = { MongoDBCollection };
  }
});

// node_modules/realm/lib/user.js
var require_user = __commonJS({
  "node_modules/realm/lib/user.js"(exports, module2) {
    var { EJSON } = require_bson();
    var { MongoDBCollection } = require_mongo_client();
    var { cleanArguments, promisify } = require_utils();
    var instanceMethods = {
      ...
      async callFunction(name, ...args) {
        return this._callFunctionOnService(name, void 0, ...args);
      },
      ...
      get functions() {
        return this._functionsOnService(void 0);
      },
      get auth() {
        const user = this;
        return new Proxy(
...
// node_modules/realm/lib/subscription-set.js
var require_subscription_set = __commonJS({
  "node_modules/realm/lib/subscription-set.js"(exports, module2) {
    var { promisify } = require_utils();
    var instanceMethods = {
...
// node_modules/realm/lib/mutable-subscription-set.js
var require_mutable_subscription_set = __commonJS({
  "node_modules/realm/lib/mutable-subscription-set.js"(exports, module2) {
    var { symbols } = require_bundle_cjs();
    var instanceMethods = {
      add(query, options) {
...
var require_session = __commonJS({
  "node_modules/realm/lib/session.js"(exports, module2) {
    var { EJSON } = require_bson();
...
var require_credentials = __commonJS({
  "node_modules/realm/lib/credentials.js"(exports, module2) {
    var instanceMethods = {
      // none
    };
    var staticMethods = {
...
var require_email_password_auth_methods = __commonJS({
  "node_modules/realm/lib/email-password-auth-methods.js"(exports, module2) {
    var { EJSON } = require_bson();
    var { promisify } = require_utils();
    var instanceMethods = {
...
var require_api_key_auth_methods = __commonJS({
  "node_modules/realm/lib/api-key-auth-methods.js"(exports, module2) {
    var { promisify } = require_utils();
    var instanceMethods = {
      create(name) {
...
var require_errors = __commonJS({
  "node_modules/realm/lib/errors.js"(exports) {
...
var require_extensions = __commonJS({
  "node_modules/realm/lib/extensions.js"(exports, module2) {
    var { symbols } = require_bundle_cjs();
    ...
    module2.exports = function(realmConstructor) {
      Object.defineProperties(realmConstructor.Set.prototype, require_set_methods()(realmConstructor));
      Object.defineProperties(realmConstructor.Collection.prototype, require_collection_methods()(realmConstructor));
      realmConstructor.DictionaryProxy = require_dictionary().DictionaryProxy;
      ...
      realmConstructor.BSON = require_bson();
      ...
      const { DefaultNetworkTransport } = require_bundle_cjs2();
      ...
      const getFromCache = (cache, realmObj) => {
        const tableKey = realmObj._tableKey();
        let cachedMap = cache.get(tableKey);
        return cachedMap ? cachedMap.get(realmObj._objectKey()) : void 0;
      };
      Object.defineProperty(realmConstructor.Collection.prototype, "toJSON", {
        value: function toJSON(_, cache = /* @__PURE__ */ new Map()) {
          return this.map(
            (item, index) => item instanceof realmConstructor.Object ? item.toJSON(index.toString(), cache) : item
          );
        },
      ...
      Object.defineProperty(realmConstructor.Object.prototype, "toJSON", {
        value: function(_, cache = /* @__PURE__ */ new Map()) {
      ...
      Object.defineProperties(
        ...
        getOwnPropertyDescriptors({
          open(config) {
            ...
            let openLocalRealmImmediately = false;
            if (config.sync[behavior] !== void 0) {
            ...
            let openPromises = [];
            let timeoutId = null;
            if (config.sync[behavior] !== void 0 && config.sync[behavior].timeOut !== void 0) {
              let timeOut = config.sync[behavior].timeOut;
              if (typeof timeOut !== "number") {
                throw new Error(`'timeOut' must be a number: '${timeOut}'`);
              }
              let throwOnTimeOut = true;
              if (config.sync[behavior] !== void 0 && config.sync[behavior].timeOutBehavior) {
      ...
      if (realmConstructor.App.Sync) {
        ...
        let subscriptionSetMethods = require_subscription_set();
        Object.defineProperties(
        ...
        Object.defineProperties(realmConstructor.App.Sync.SubscriptionSet.prototype, {
          ...
          ...require_collection_methods()(realmConstructor)
        });
        let mutableSubscriptionSetMethods = require_mutable_subscription_set();
        Object.defineProperties(
        ...
        let sessionMethods = require_session();
...
var require_lib3 = __commonJS({
  "node_modules/realm/lib/index.js"(exports, module2) {
    ...
    var realmConstructor = require_bindings()("realm.node").Realm;
    require_extensions()(realmConstructor, environment);
    var versions = utils.getVersions();
    realmConstructor.App._setVersions(versions);
    module2.exports = realmConstructor;
  }
});
...
var import_realm3 = __toESM(require_lib3());

// common/ModelMessage.ts
var import_realm = __toESM(require_lib3());
var ModelMessage = class extends import_realm.default.Object {
  static schema = {
    name: "Message",
    properties: {
      _id: { type: "objectId", default: () => new import_realm.default.BSON.ObjectId() },
      fromUserName: "string?",
      toUserName: "string?",
      fromUserId: "objectId?",
      toUserId: "objectId?",
...
// common/ModelUser.ts
var import_realm2 = __toESM(require_lib3());
var ModelUser = class extends import_realm2.default.Object {
  static schema = {
    name: "User",
    properties: {
      _id: { type: "objectId", default: () => new import_realm2.default.BSON.ObjectId() },
      userName: "string?"
    },
    primaryKey: "_id"
  };
...
var openDb = async () => {
  let dbPath = import_path.default.join(import_electron.app.getPath("userData"), "db");
  let exist = await import_fs_extra.default.pathExists(dbPath);
  if (!exist) {
    await import_fs_extra.default.mkdir(dbPath);
  }
  let key = new Int8Array(64);
  let userId = "liuxiaolun";
  userId = `***!!!${userId}!!!***`;
  userId = import_crypto.default.createHash("md5").update(userId).digest("hex");
  for (let i = 0; i < 64; i++) {
    key[i] = parseInt(userId[i >= 32 ? i - 32 : i], 36);
  }
  db = await import_realm3.default.open({
    path: import_path.default.join(dbPath, "db"),
...
var initUser = async () => {
  ...
  await db.write(() => {
    db.create(ModelUser, {
      _id: new import_realm3.default.BSON.ObjectID(),
      userName: "\u674E\u6E05\u7167"
    });
    db.create(ModelUser, {
      _id: new import_realm3.default.BSON.ObjectID(),
...
var handleWriteData = () => {
  import_electron.ipcMain.handle("writeToDb", async (event, data) => {
    data._id = new import_realm3.default.BSON.ObjectID();
    await db.write(() => {
      db.create(ModelMessage, data);
    });
    return true;
  });
};
